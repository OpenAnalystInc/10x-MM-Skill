...
**IMPORTANT**: Page hosting uses the site-deployments API, NOT `links_upsert`. The `links_upsert` tool only creates redirect links — it does NOT host HTML pages (the `html` param is ignored).
